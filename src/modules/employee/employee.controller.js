...
const createEmployee = async (req, res)=>{
    ...
    const signed_in = req.body.signed_in ? req.body.signed_in.trim():'';
    ...
    const last_drawn_salary = req.body.last_drawn_salary ? req.body.last_drawn_salary:'';
    ...
    const probation_start_date = req.body.probation_start_date ? req.body.probation_start_date:'';
    const probation_end_date = req.body.probation_end_date ? req.body.probation_end_date:'';
    const shift_type_header_id  = req.body.shift_type_header_id  ? req.body.shift_type_header_id :'';
    const shift_start_date = req.body.start_date ? req.body.start_date:'';
    const shift_end_date = req.body.end_date ? req.body.end_date:'';
    const work_week_pattern_id = req.body.work_week_pattern_id ? req.body.work_week_pattern_id:'';
    const work_start_date = req.body.start_date ? req.body.start_date:'';
...
const updateEmployee = async (req, res) => {
    ...
    try {
        ...
        const updateBankQuery = `
            ...
            SET payment_mode = ?, bank_name = ?, ifsc_code = ?, branch_name = ?
            WHERE employee_id = ?
        `;
