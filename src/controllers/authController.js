...
exports.login = async (req, res) => {
    ...
    try {
        const [rows] = await pool.query(
            `SELECT u.*, t.extenstions AS password, e.reporting_manager_id, e.employee_code,  e.signed_in, ee.first_name AS reporting_manager_first_name, ee.last_name AS reporting_manager_last_name 
             FROM users u
